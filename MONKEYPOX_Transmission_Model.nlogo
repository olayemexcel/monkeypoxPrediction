; Improving Epidemiological Diseases Mitigation: A case study of Monkeypox using Agent-based Modelling with Netlogo
...
"Total-Human-Recovery" 1.0 0 -5509967 true "" "plot total_recovered_cases"
...
The output fields provide insights into the simulation by displaying information such as total cases, currently infected individuals, human deaths, immunised individuals contracting the virus, total recovered, and more. The number of infections over time is represented via a plot.
